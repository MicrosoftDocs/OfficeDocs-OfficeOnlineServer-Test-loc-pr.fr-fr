---
title: Référence technique pour Office Web Apps Server
TOCTitle: Référence technique
ms:assetid: aa64a67c-d83a-4548-ac85-9f749b7dc407
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ219447(v=office.15)
ms:contentKeyID: 49645226
ms.date: 01/03/2018
...
**Résumé :** contient des liens vous permettant d'accéder à des articles de référence technique, contenant, par exemple, de l'aide sur les cmdlets Windows PowerShell OfficeWebApps pour Office Web Apps Server.

**Public concerné** : professionnels de l'informatique

![Logo Office 2013](images/JJ219457.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Logo Office 2013") Office Web Apps Server est un nouveau produit Office Server qui offre des versions de Word, de PowerPoint, d'Excel et de OneNote basées sur le navigateur. Une seule batterie Office Web Apps Server peut prendre en charge des utilisateurs qui accèdent aux fichiers Office via SharePoint 2013, Lync Server 2013, Exchange Server 2013, des dossiers partagés et des sites web. Le tableau suivant répertorie et décrit les articles de références techniques destinés aux professionnels de l'informatique qui déploient Office Web Apps Server localement dans leurs organisations.


### Articles de références techniques Office Web Apps Server sur TechNet
