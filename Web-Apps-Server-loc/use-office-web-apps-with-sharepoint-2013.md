---
title: Utiliser Office Web Apps avec SharePoint 2013
TOCTitle: Utiliser Office Web Apps avec SharePoint 2013
ms:assetid: 8a58e6c2-9a0e-4355-ae41-4df25e5e6eee
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Ee855124(v=office.15)
ms:contentKeyID: 49645216
ms.date: 01/03/2018
...
Conjugué à une installation locale de SharePoint 2013, Office Web Apps fournit des versions mises à jour des applications Word Web App, Excel Web App, PowerPoint Web App et OneNote Web App. Les utilisateurs peuvent consulter, et éventuellement modifier, des documents Office s’ils utilisent un navigateur web reconnu sur les ordinateurs et divers appareils mobiles (Windows Phone, iPhone, iPad, etc.). Outre les nouvelles fonctionnalités d’Office Web Apps, l’architecture et les méthodes de déploiement ont également été modifiées, ce qui permet à Office Web Apps de fournir des fonctionnalités d’affichage pour Lync Server 2013.

![Logo Office 2013](images/JJ219457.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Logo Office 2013")Les articles du tableau suivant sont destinés aux professionnels de l’informatique qui prévoient de configurer SharePoint 2013 pour utiliser Office Web Apps localement dans leur organisation.

### Articles Office Web Apps sur TechNet
...
<tbody>
<tr class="odd">
<td><p><a href="how-office-web-apps-work-on-premises-with-sharepoint-2013.md">Fonctionnement de Office Web Apps sur site avec SharePoint 2013</a></p></td>
<td><p>Fournit des informations sur Office Web Apps, la manière de l’obtenir et son fonctionnement sur site avec SharePoint 2013.</p></td>
</tr>
<tr class="even">
<td><p><a href="what’s-new-with-office-web-apps-when-used-with-sharepoint-2013.md">Nouveautés d’Office Web Apps avec SharePoint 2013</a></p></td>
<td><p>Décrit les nouvelles fonctionnalités disponibles pour les utilisateurs et les administrateurs SharePoint 2013 en cas d’utilisation d’Office Web Apps.</p></td>
</tr>
<tr class="odd">
<td><p><a href="plan-office-web-apps-used-with-sharepoint-2013.md">Planification d'Office Web Apps (utilisé avec SharePoint 2013)</a></p></td>
<td><p>Fournit des instructions de planification pour Office Web Apps quand il est utilisé avec SharePoint 2013.</p></td>
</tr>
<tr class="even">
<td><p><a href="configure-office-web-apps-for-sharepoint-2013.md">Configurer Office Web Apps pour SharePoint 2013</a></p></td>
<td><p>Fournit des informations sur la manière de configurer SharePoint 2013 pour utiliser Office Web Apps dans un environnement de test.</p></td>
</tr>
<tr class="odd">
<td><p><a href="set-the-default-open-behavior-for-browser-enabled-documents-office-web-apps-when-used-with-sharepoint-2013.md">Configuration du comportement d’ouverture par défaut des documents activés pour le navigateur (Office Web Apps dans le cadre d’une utilisation avec SharePoint 2013)</a></p></td>
<td><p>Fournit des informations sur la configuration du comportement d’ouverture par défaut des documents Office dans les collections de sites et bibliothèques de documents SharePoint.</p></td>
</tr>
<tr class="even">
<td><p><a href="video-configure-office-web-apps-for-sharepoint-2013.md">Vidéo : Configurer Office Web Apps pour SharePoint 2013</a></p></td>
<td><p>Vous guide tout au long des neuf étapes principales de la configuration d’une batterie de serveurs Office Web Apps Server afin qu’elle fonctionne avec SharePoint 2013.</p></td>
</tr>
<tr class="odd">
<td><p><a href="technical-reference-for-office-web-apps-with-sharepoint-2013.md">Référence technique pour Office Web Apps (avec SharePoint 2013)</a></p></td>
<td><p>Fournit des liens vers les articles de références techniques, comme par exemple de l’aide pour les cmdlets Windows PowerShell SPWOPI pour Office Web Apps.</p></td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td><p></p>
<img src="images/JJ219457.22cad0f4-303d-4a40-90a3-fa08e69dfdaf(Office.15).png" title="Icône Nouveautés (boîte)" alt="Icône Nouveautés (boîte)" /></td>
<td><p><strong>Contenu récemment publié</strong></p></td>
<td><p>Consultez l’article suivant pour obtenir une liste des articles, nouveaux ou récemment mis à jour, consacrés à Office Web Apps.</p>
<ul>
...
<tr class="even">
<td><p></p>
<img src="images/JJ219457.6b2d6dfa-7dc8-40fb-8335-af68b575f8cb(Office.15).png" title="Prise en main" alt="Prise en main" /></td>
...
<ul>
<li><p><a href="https://go.microsoft.com/fwlink/p/?linkid=263945">Centre de téléchargement Microsoft</a></p></li>
</ul>
<p>Explorez ces liens pour savoir comment implémenter Office Web Apps Server et SharePoint 2013.</p>
<ul>
...
<tr class="odd">
<td><p></p>
<img src="images/JJ219457.6fa793ee-ede9-4476-901c-de96ea37fc3a(Office.15).png" title="Icône Conversation" alt="Icône Conversation" /></td>
