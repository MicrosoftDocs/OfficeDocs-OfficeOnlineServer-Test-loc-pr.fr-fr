---
title: "Déployer l'infrastructure : Office Web Apps Server"
TOCTitle: "Déployer l'infrastructure : Office Web Apps Server"
ms:assetid: ec93a103-8072-435f-9e80-897c0aa7b914
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ219458(v=office.15)
ms:contentKeyID: 49645251
ms.date: 01/03/2018
mtps_version: v=office.15
ms.translationtype: HT
---

# Déployer l'infrastructure : Office Web Apps Server
...
**Résumé :** contient des articles relatifs à Office Web Apps Server et la manière dont il distribue la fonctionnalité Office Web Apps aux hôtes.

**Public concerné** : professionnels de l'informatique

Office Web Apps Server est un nouveau produit Office Server qui offre des versions de Word, PowerPoint, Excel et OneNotebasées sur le navigateur. Une seule batterie Office Web Apps Server peut prendre en charge des utilisateurs qui accèdent aux fichiers Office via SharePoint 2013, Lync Server 2013, Exchange Server 2013, des dossiers partagés et des sites web. Le nouveau modèle de déploiement autonome signifie que vous pouvez gérer des mises à jour de votre batterie Office Web Apps Server indépendamment des autres produits Office Server déployés dans votre organisation.

![Logo Office 2013](images/JJ219457.a106e261-2cd0-43b7-af77-92de7e4b6fb9(Office.15).png "Logo Office 2013")Les articles du tableau suivant sont destinés aux professionnels de l'informatique qui prévoient de configurer Office Web Apps Server pour utiliser OfficeWebAccess\_2nd\_CurrentVer localement dans leur organisation.

### Articles Office Web Apps Server sur TechNet
...
<tbody>
<tr class="odd">
<td><p><a href="office-web-apps-server-overview.md">Vue d'ensemble d'Office Web Apps Server</a></p></td>
<td><p>Découvrez comment Office Web Apps Server fournit une fonctionnalité Office basée sur un navigateur à des hôtes locaux dans votre organisation.</p></td>
</tr>
<tr class="even">
<td><p><a href="plan-office-web-apps-server.md">Planification d'Office Web Apps Server</a></p></td>
<td><p>En savoir plus sur la configuration requise d'Office Web Apps Server, telle que le protocole HTTPS, les certificats, la virtualisation, l'équilibrage de charge, les topologies et la sécurité.</p></td>
</tr>
<tr class="odd">
<td><p><a href="deploy-office-web-apps-server.md">Déployer Office Web Apps Server</a></p></td>
<td><p>Découvrez comment déployer Office Web Apps Server localement.</p></td>
</tr>
<tr class="even">
<td><p><a href="technical-reference-for-office-web-apps-server.md">Référence technique pour Office Web Apps Server</a></p></td>
<td><p>Trouvez des articles de références techniques pour Office Web Apps Server, notamment de l'aide pour les cmdlets Windows PowerShell OfficeWebApps.</p></td>
</tr>
</tbody>
</table>
